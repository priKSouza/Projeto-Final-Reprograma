    ...
    <>
      ...
      <div className="sessao-quiz">
        <p className="texto-quiz">
          ...
          que estão começando os estudos em programação. Mas calma, as perguntas
          são bem fáceis. O Quiz contém 3 perguntinhas sobre cada lingaguem:
          HTML 5, CSS 3, JavaScript e React. <br />
